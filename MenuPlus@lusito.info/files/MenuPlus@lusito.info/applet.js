...
MyApplet.prototype = {
    ...
    _init: function(metadata, orientation, panel_height, instance_id) {
        ...
        this.applicationsScrollBox = null;
    ...
    _initSettings: function(instance_id, uuid) {
        ...
        this.settings.bindProperty(Settings.BindingDirection.ONE_WAY, "show-appinfo-description-multiline", "showAppInfoDescriptionMultiline", function() {});
        this.settings.bindProperty(Settings.BindingDirection.ONE_WAY, "appinfo-align-right", "alignAppInfoRight", this._refreshAppInfo);
        ...
        this.settings.bindProperty(Settings.BindingDirection.ONE_WAY, "enable-autoscroll", "enableAutoScroll", this._refreshEnableAutoScroll);
        this.settings.bindProperty(Settings.BindingDirection.ONE_WAY, "searchbox-position", "searchBoxPosition", this._refreshSearchBoxPosition);
    ...
    _refreshEnableAutoScroll: function() {
        if(this.applicationsScrollBox && this.applicationsScrollBox.set_auto_scrolling)
    ...
    _refreshAppInfo: function() {
        ...
        if(this.alignAppInfoRight) {
            this.selectedAppTitle.set_style('text-align:right;');
            this.selectedAppDescription.set_style('text-align:right;font-size: 10pt;font-style: italic;max-width:250px');
        } else {
            this.selectedAppTitle.set_style('text-align:left;');
            this.selectedAppDescription.set_style('text-align:left;font-size: 10pt;font-style: italic;max-width:250px');
        }
    },
    
    _refreshSearchBoxPosition: function() {
        if(this.searchBoxPosition == 'top' || this._orientation == St.Side.TOP) {
            _reparentActor(this.searchBox, this.topRightPane);
            _reparentActor(this.selectedAppBox, this.bottomPane);
        } else {
            _reparentActor(this.selectedAppBox,this.topPane);
            _reparentActor(this.searchBox,this.bottomRightPane);
        }
    },
    ...
    _display : function() {
        ...
        this.categoriesBox = new St.BoxLayout({ style_class: 'menu-categories-box', style: 'padding-left: 5px;padding-top: 5px;padding-right: 7px;', vertical: true });
        ...
        this.applicationsBox = new St.BoxLayout({ style_class: 'menu-applications-box', style: 'padding-top: 5px;padding-left: 7px;', vertical:true });
        ...
        this.selectedAppBox = new St.BoxLayout({ style_class: 'menu-selected-app-box', style: 'padding-left: 20px;padding-top: 5px; padding-bottom: 0;', vertical: true });
        ...
        this.selectedAppDescription.clutter_text.set_line_wrap(this.showAppInfoDescriptionMultiline);
        ...
        this.mainBox = new St.BoxLayout({ style_class: 'menu-applications-box', style: 'padding-top: 5px;', vertical:false });
        ...
        this._refreshSearchBoxPosition();
