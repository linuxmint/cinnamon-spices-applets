...
- Als een pull-verzoek vertalingen toevoegt, worden deze samengevoegd. Deze zullen de functionaliteit niet beïnvloeden en zullen de applet beschikbaar maken voor gebruikers die het eerder niet konden gebruiken vanwege een taalbarrière. We beschouwen dit als een foutreparatie,wat het eigenlijk niet is.
