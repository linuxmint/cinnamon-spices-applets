...
class CinnamonMenuSettings:
	...
	self.vbox.add(self.app_icon_size)
        ...
        self.cat_icon_size = GSettingsSpinButton("Category icon size", "org.cinnamon.applets.classicMenu", "categories-icon-size", 0, 50, 1, 1, "")
        self.vbox.add(self.cat_icon_size)

        self.left_icon_size = GSettingsSpinButton("Left icon size", "org.cinnamon.applets.classicMenu", "left-icon-size", 0, 50, 1, 1, "")
        self.vbox.add(self.left_icon_size)
        ...
        self.package_manager = GSettingsEntry("Package Manager used", "org.cinnamon.applets.classicMenu", "package-manager")
        self.vbox.add(self.package_manager);
