...
TimerApplet.prototype = {
	...
	_init: function(metadata, orientation, panel_height, instance_id) {
		...
		this.turnOffSwitchMenuItem = new PopupMenu.PopupSwitchMenuItem("Turn off computer on timer");
		...
		if (this.period >= 0) {
			...
			if (this.turnOffSwitchMenuItem.state) {
				...
				if (this.showNotifications) {
					...
					let notification = new MessageTray.Notification(source, "Timer", "Time's up!");
