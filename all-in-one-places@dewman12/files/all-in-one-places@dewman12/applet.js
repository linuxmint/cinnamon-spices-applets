...
const EXTENSION_UUID = "all-in-one-places@dewman12";
const SCHEMA_NAME = "org.cinnamon.applets.AllInOnePlaces";
const APPLET_DIR = imports.ui.appletManager.appletMeta["all-in-one-places@dewman12"].path;
...
MyApplet.prototype =
{
    ...
    _displayMenu : function()
    {
        ...
        if (settings.get_boolean('show-network-section')) {
            ...
            let connect_item = new MenuItem('nemo-globe', _("Connect to..."), settings.get_string('connect-command'));
