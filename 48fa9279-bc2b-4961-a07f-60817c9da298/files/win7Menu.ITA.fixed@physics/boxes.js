...
RightButtonsBox.prototype = {
    ...
    addItems: function () {
        ...
        this.documents = new Items.TextBoxItem(_("Documenti"), "folder-documents", "Util.spawnCommandLine('nautilus Documenti')", this.menu, this.hoverIcon, false);
        this.pictures = new Items.TextBoxItem(_("Immagini"), "folder-pictures", "Util.spawnCommandLine('nautilus Immagini')", this.menu, this.hoverIcon, false);
        this.music = new Items.TextBoxItem(_("Musica"), "folder-music", "Util.spawnCommandLine('nautilus Musica')", this.menu, this.hoverIcon, false);
        this.videos = new Items.TextBoxItem(_("Video"), "folder-videos", "Util.spawnCommandLine('nautilus Video')", this.menu, this.hoverIcon, false);
        ...
        this.packageItem = new Items.TextBoxItem(_("Gestore Pacchetti"), "synaptic", "Util.spawnCommandLine('gksu synaptic')", this.menu, this.hoverIcon, false);
        this.control = new Items.TextBoxItem(_("Impostazioni"), "gnome-control-center", "Util.spawnCommandLine('gnome-control-center')", this.menu, this.hoverIcon, false);
        this.run = new Items.TextBoxItem(_("Esegui"), "system-run", "Main.getRunDialog().open()", this.menu, this.hoverIcon, false);
        this.terminal = new Items.TextBoxItem(_("Terminale"), "terminal", "Util.spawnCommandLine('gnome-terminal')", this.menu, this.hoverIcon, false);
        this.help = new Items.TextBoxItem(_("Aiuto"), "help", "Util.spawnCommandLine('yelp')", this.menu, this.hoverIcon, false);
        this.shutdown = new Items.TextBoxItem("Arresta", "system-shutdown", "Session.ShutdownRemote()", this.menu, this.hoverIcon, false);
