//System Shutdown and Restart Applet by Shelley, updated and translated to German by DeathMD, updated to SystemD by joshbowyer
...
//                Util.spawnCommandLine("dbus-send --session --type=method_call --print-reply --dest=org.gnome.SessionManager /org/gnome/SessionManager org.gnome.SessionManager.Logout uint32:1");
                Util.spawnCommandLine("dbus-send --system --print-reply --dest=org.freedesktop.login1 /org/freedesktop/login1 'org.freedesktop.login1.Manager.TerminateSession' string:c2");
            });
