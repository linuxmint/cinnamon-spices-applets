declare namespace imports.gi.Clutter {
    ...
    class AlignConstraint {
         ...
         */
        static new(source: Actor, axis: AlignAxis, factor: number): Constraint;
    }
    ...
    class Alpha {
         ...
         * @returns the newly created {@link Alpha}
         */
        static new_with_func(timeline: Timeline, _func: AlphaFunc, data: any, destroy: GLib.DestroyNotify): Alpha;
        /**
         ...
         * @returns the logical id of the alpha function
         */
        static register_func(_func: AlphaFunc, data: any): number;
    }
    ...
    class BehaviourDepth {
         ...
         */
        static new(alpha: Alpha, depth_start: number, depth_end: number): Behaviour;
    }
    ...
    class BehaviourEllipse {
         ...
         */
        static new(alpha: Alpha, _x: number, _y: number, width: number, height: number, direction: RotateDirection, start: number, _end: number): Behaviour;
    }
    ...
    class BehaviourOpacity {
         ...
         */
        static new(alpha: Alpha, opacity_start: number, opacity_end: number): Behaviour;
    }
    ...
    class BehaviourPath {
         ...
         */
        static new(alpha: Alpha, path: Path): Behaviour;
        /**
         ...
         * @returns a {@link Behaviour}
         */
        static new_with_description(alpha: Alpha, desc: string): Behaviour;
        /**
         ...
         * @returns a {@link Behaviour}
         */
        static new_with_knots(alpha: Alpha, knots: Knot[], n_knots: number): Behaviour;
    }
    ...
    class BehaviourRotate {
         ...
         */
        static new(alpha: Alpha, axis: RotateAxis, direction: RotateDirection, angle_start: number, angle_end: number): Behaviour;
    }
    ...
    class BehaviourScale {
         ...
         */
        static new(alpha: Alpha, x_scale_start: number, y_scale_start: number, x_scale_end: number, y_scale_end: number): Behaviour;
    }
    ...
    class BinLayout {
         ...
         */
        static new(x_align: BinAlignment, y_align: BinAlignment): LayoutManager;
    }
    ...
    class BindConstraint {
         ...
         */
        static new(source: Actor, coordinate: BindCoordinate, offset: number): Constraint;
    }
    ...
    class BindingPool {
         ...
         *   be freed directly
         */
        static get_for_class(klass: any): BindingPool;
    }
    ...
    class Box {
         ...
         */
        static new(manager: LayoutManager): Actor;
    }
    ...
    class CairoTexture {
         ...
         */
        static new(width: number, height: number): Actor;
    }
    ...
    class ColorNode {
         ...
         */
        static new(color: Color): PaintNode;
    }
    ...
    class DesaturateEffect {
         ...
         */
        static new(factor: number): Effect;
    }
    ...
    class FlowLayout {
         ...
         */
        static new(orientation: FlowOrientation): LayoutManager;
    }
    ...
    class Interval {
         ...
         * @returns the newly created {@link Interval}
         */
        static new(gtype: GObject.Type): Interval;
        /**
         ...
         * @returns the newly created {@link Interval}
         */
        static new_with_values(gtype: GObject.Type, initial: GObject.Value, _final: GObject.Value): Interval;
        /**
         ...
         */
        static register_progress_func(value_type: GObject.Type, _func: ProgressFunc): void;
    }
    ...
    class KeyframeTransition {
         ...
         */
        static new(property_name: string): Transition;
    }
    ...
    class ListModel {
         ...
         */
        static new(n_columns: number): Model;
        /**
         ...
         */
        static newv(n_columns: number, types: GObject.Type[], names: string[]): Model;
    }
    ...
    class PageTurnEffect {
         ...
         */
        static new(period: number, angle: number, radius: number): Effect;
    }
    ...
    class PathConstraint {
         ...
         */
        static new(path: Path, offset: number): Constraint;
    }
    ...
    class Rectangle {
         ...
         * @returns a new {@link Rectangle}
         */
        static new_with_color(color: Color): Actor;
    }
    ...
    class ShaderEffect {
         ...
         *   Use g_object_unref() when done.
         */
        static new(shader_type: ShaderType): Effect;
    }
    ...
    class SnapConstraint {
         ...
         */
        static new(source: Actor, from_edge: SnapEdge, to_edge: SnapEdge, offset: number): Constraint;
    }
    ...
    class Text {
         ...
         * @returns the newly created {@link Text} actor
         */
        static new_full(font_name: string, text: string, color: Color): Actor;
        /**
         ...
         * @returns the newly created {@link Text} actor
         */
        static new_with_text(font_name: string, text: string): Actor;
    }
    ...
    class TextBuffer {
         ...
         * @returns A new ClutterTextBuffer object.
         */
        static new_with_text(text: string, text_len: number): TextBuffer;
    }
    ...
    class TextNode {
         ...
         *   Use clutter_paint_node_unref() when done
         */
        static new(layout: Pango.Layout, color: Color): PaintNode;
    }
    ...
    class Texture {
         ...
         */
        static new_from_actor(actor: Actor): Actor;
        /**
    ...
    class TextureNode {
         ...
         *   Use clutter_paint_node_unref() when done
         */
        static new(texture: Cogl.Texture, color: Color, min_filter: ScalingFilter, mag_filter: ScalingFilter): PaintNode;
    }
    ...
    class ActionClass {
        ...
        _clutter_action1: { (): void; };
        _clutter_action2: { (): void; };
        _clutter_action3: { (): void; };
        _clutter_action4: { (): void; };
        _clutter_action5: { (): void; };
        _clutter_action6: { (): void; };
        _clutter_action7: { (): void; };
        _clutter_action8: { (): void; };
    }
    ...
    class ActorClass {
        ...
        get_preferred_width: { (self: Actor, for_height: number, min_width_p: number, natural_width_p: number): void; };
        get_preferred_height: { (self: Actor, for_width: number, min_height_p: number, natural_height_p: number): void; };
    ...
    class ActorMetaClass {
        public parent_class: GObject.InitiallyUnownedClass;
        set_actor: { (meta: ActorMeta, actor: Actor): void; };
        _clutter_meta1: { (): void; };
        _clutter_meta2: { (): void; };
        _clutter_meta3: { (): void; };
        _clutter_meta4: { (): void; };
    ...
    class AlphaClass {
        public parent_class: GObject.InitiallyUnownedClass;
        _clutter_alpha_1: { (): void; };
        _clutter_alpha_2: { (): void; };
        _clutter_alpha_3: { (): void; };
        _clutter_alpha_4: { (): void; };
        _clutter_alpha_5: { (): void; };
    }
    ...
    class AnimatableIface {
        ...
        animate_property: { (animatable: Animatable, animation: Animation, property_name: string, initial_value: GObject.Value, final_value: GObject.Value, progress: number, value: GObject.Value): boolean; };
        find_property: { (animatable: Animatable, property_name: string): GObject.ParamSpec; };
        get_initial_state: { (animatable: Animatable, property_name: string, value: GObject.Value): void; };
        set_final_state: { (animatable: Animatable, property_name: string, value: GObject.Value): void; };
        interpolate_value: { (animatable: Animatable, property_name: string, interval: Interval, progress: number, value: GObject.Value): boolean; };
    }
    ...
    class AnimationClass {
        ...
        _clutter_reserved1: { (): void; };
        _clutter_reserved2: { (): void; };
        _clutter_reserved3: { (): void; };
        _clutter_reserved4: { (): void; };
        _clutter_reserved5: { (): void; };
        _clutter_reserved6: { (): void; };
        _clutter_reserved7: { (): void; };
        _clutter_reserved8: { (): void; };
    }
    ...
    class BehaviourClass {
        ...
        _clutter_behaviour1: { (): void; };
        _clutter_behaviour2: { (): void; };
        _clutter_behaviour3: { (): void; };
        _clutter_behaviour4: { (): void; };
        _clutter_behaviour5: { (): void; };
        _clutter_behaviour6: { (): void; };
    }
    ...
    class BehaviourPathClass {
        ...
        _clutter_path_1: { (): void; };
        _clutter_path_2: { (): void; };
        _clutter_path_3: { (): void; };
        _clutter_path_4: { (): void; };
    }
    ...
    class CairoTextureClass {
        ...
        _clutter_cairo_3: { (): void; };
        _clutter_cairo_4: { (): void; };
    }
    ...
    class ClickActionClass {
        ...
        _clutter_click_action1: { (): void; };
        _clutter_click_action2: { (): void; };
        _clutter_click_action3: { (): void; };
        _clutter_click_action4: { (): void; };
        _clutter_click_action5: { (): void; };
        _clutter_click_action6: { (): void; };
        _clutter_click_action7: { (): void; };
    }
    ...
    class CloneClass {
        public parent_class: ActorClass;
        _clutter_actor_clone1: { (): void; };
        _clutter_actor_clone2: { (): void; };
        _clutter_actor_clone3: { (): void; };
        _clutter_actor_clone4: { (): void; };
    }
    ...
    class ConstraintClass {
        ...
        _clutter_constraint1: { (): void; };
        _clutter_constraint2: { (): void; };
        _clutter_constraint3: { (): void; };
        _clutter_constraint4: { (): void; };
        _clutter_constraint5: { (): void; };
        _clutter_constraint6: { (): void; };
        _clutter_constraint7: { (): void; };
    }
    ...
    class ContainerIface {
        ...
        raise: { (container: Container, actor: Actor, sibling: Actor): void; };
        lower: { (container: Container, actor: Actor, sibling: Actor): void; };
    ...
    class ContentIface {
        public g_iface: GObject.TypeInterface;
        get_preferred_size: { (content: Content, width: number, height: number): boolean; };
    ...
    class DeformEffectClass {
        ...
        _clutter_deform1: { (): void; };
        _clutter_deform2: { (): void; };
        _clutter_deform3: { (): void; };
        _clutter_deform4: { (): void; };
        _clutter_deform5: { (): void; };
        _clutter_deform6: { (): void; };
        _clutter_deform7: { (): void; };
    }
    ...
    class DeviceManagerClass {
        public parent_class: GObject.ObjectClass;
        public _padding: any[];
        get_devices: { (device_manager: DeviceManager): GLib.SList; };
    ...
    class DragActionClass {
        ...
        _clutter_drag_action1: { (): void; };
        _clutter_drag_action2: { (): void; };
        _clutter_drag_action3: { (): void; };
        _clutter_drag_action4: { (): void; };
    }
    ...
    class DropActionClass {
        ...
        _clutter_drop_action1: { (): void; };
        _clutter_drop_action2: { (): void; };
        _clutter_drop_action3: { (): void; };
        _clutter_drop_action4: { (): void; };
        _clutter_drop_action5: { (): void; };
        _clutter_drop_action6: { (): void; };
        _clutter_drop_action7: { (): void; };
        _clutter_drop_action8: { (): void; };
    }
    ...
    class EffectClass {
        ...
        _clutter_effect4: { (): void; };
        _clutter_effect5: { (): void; };
        _clutter_effect6: { (): void; };
    }
    ...
    class GestureActionClass {
        ...
        _clutter_gesture_action1: { (): void; };
        _clutter_gesture_action2: { (): void; };
        _clutter_gesture_action3: { (): void; };
        _clutter_gesture_action4: { (): void; };
        _clutter_gesture_action5: { (): void; };
        _clutter_gesture_action6: { (): void; };
    }
    ...
    class IntervalClass {
        ...
        compute_value: { (interval: Interval, factor: number, value: GObject.Value): boolean; };
        _clutter_reserved1: { (): void; };
        _clutter_reserved2: { (): void; };
        _clutter_reserved3: { (): void; };
        _clutter_reserved4: { (): void; };
    ...
    class LayoutManagerClass {
        public parent_class: GObject.InitiallyUnownedClass;
        get_preferred_width: { (manager: LayoutManager, container: Container, for_height: number, min_width_p: number, nat_width_p: number): void; };
        get_preferred_height: { (manager: LayoutManager, container: Container, for_width: number, min_height_p: number, nat_height_p: number): void; };
        allocate: { (manager: LayoutManager, container: Container, allocation: ActorBox, flags: AllocationFlags): void; };
        set_container: { (manager: LayoutManager, container: Container): void; };
        get_child_meta_type: { (manager: LayoutManager): GObject.Type; };
        create_child_meta: { (manager: LayoutManager, container: Container, actor: Actor): LayoutMeta; };
        ...
        _clutter_padding_1: { (): void; };
        _clutter_padding_2: { (): void; };
        _clutter_padding_3: { (): void; };
        _clutter_padding_4: { (): void; };
        _clutter_padding_5: { (): void; };
        _clutter_padding_6: { (): void; };
        _clutter_padding_7: { (): void; };
        _clutter_padding_8: { (): void; };
    }
    ...
    class LayoutMetaClass {
        ...
        _clutter_padding1: { (): void; };
        _clutter_padding2: { (): void; };
        _clutter_padding3: { (): void; };
        _clutter_padding4: { (): void; };
    }
    ...
    class ModelClass {
        ...
        insert_row: { (model: Model, index_: number): ModelIter; };
        remove_row: { (model: Model, _row: number): void; };
        get_iter_at_row: { (model: Model, _row: number): ModelIter; };
        resort: { (model: Model, _func: ModelSortFunc, data: any): void; };
        ...
        _clutter_model_1: { (): void; };
        _clutter_model_2: { (): void; };
        _clutter_model_3: { (): void; };
        _clutter_model_4: { (): void; };
        _clutter_model_5: { (): void; };
        _clutter_model_6: { (): void; };
        _clutter_model_7: { (): void; };
        _clutter_model_8: { (): void; };
    }
    ...
    class ModelIterClass {
        public parent_class: GObject.ObjectClass;
        get_value: { (iter: ModelIter, column: number, value: GObject.Value): void; };
        set_value: { (iter: ModelIter, column: number, value: GObject.Value): void; };
        ...
        _clutter_model_iter_1: { (): void; };
        _clutter_model_iter_2: { (): void; };
        _clutter_model_iter_3: { (): void; };
        _clutter_model_iter_4: { (): void; };
        _clutter_model_iter_5: { (): void; };
        _clutter_model_iter_6: { (): void; };
        _clutter_model_iter_7: { (): void; };
        _clutter_model_iter_8: { (): void; };
    }
    ...
    class OffscreenEffectClass {
        ...
        _clutter_offscreen1: { (): void; };
        _clutter_offscreen2: { (): void; };
        _clutter_offscreen3: { (): void; };
        _clutter_offscreen4: { (): void; };
        _clutter_offscreen5: { (): void; };
        _clutter_offscreen6: { (): void; };
        _clutter_offscreen7: { (): void; };
    }
    ...
    class PanActionClass {
        ...
        _clutter_pan_action1: { (): void; };
        _clutter_pan_action2: { (): void; };
        _clutter_pan_action3: { (): void; };
        _clutter_pan_action4: { (): void; };
        _clutter_pan_action5: { (): void; };
        _clutter_pan_action6: { (): void; };
    }
    ...
    class RectangleClass {
        public parent_class: ActorClass;
        _clutter_rectangle1: { (): void; };
        _clutter_rectangle2: { (): void; };
        _clutter_rectangle3: { (): void; };
        _clutter_rectangle4: { (): void; };
    }
    ...
    class RotateActionClass {
        ...
        _clutter_rotate_action1: { (): void; };
        _clutter_rotate_action2: { (): void; };
        _clutter_rotate_action3: { (): void; };
        _clutter_rotate_action4: { (): void; };
        _clutter_rotate_action5: { (): void; };
        _clutter_rotate_action6: { (): void; };
        _clutter_rotate_action7: { (): void; };
    }
    ...
    class ScoreClass {
        ...
        _clutter_score_1: { (): void; };
        _clutter_score_2: { (): void; };
        _clutter_score_3: { (): void; };
        _clutter_score_4: { (): void; };
        _clutter_score_5: { (): void; };
    }
    ...
    class ScriptableIface {
        ...
        // parse_custom_node: {(scriptable: Scriptable, script: Script, value: GObject.Value, name: string, node: Json.Node): boolean;};
        set_custom_property: { (scriptable: Scriptable, script: Script, name: string, value: GObject.Value): void; };
    }
    ...
    class ShaderEffectClass {
        ...
        _clutter_shader1: { (): void; };
        _clutter_shader2: { (): void; };
        _clutter_shader3: { (): void; };
        _clutter_shader4: { (): void; };
        _clutter_shader5: { (): void; };
    }
    ...
    class SwipeActionClass {
        ...
        _clutter_swipe_action1: { (): void; };
        _clutter_swipe_action2: { (): void; };
        _clutter_swipe_action3: { (): void; };
        _clutter_swipe_action4: { (): void; };
        _clutter_swipe_action5: { (): void; };
        _clutter_swipe_action6: { (): void; };
    }
    ...
    class TapActionClass {
        ...
        _clutter_tap_action1: { (): void; };
        _clutter_tap_action2: { (): void; };
        _clutter_tap_action3: { (): void; };
        _clutter_tap_action4: { (): void; };
        _clutter_tap_action5: { (): void; };
        _clutter_tap_action6: { (): void; };
    }
    ...
    class TextureClass {
        ...
        _clutter_texture1: { (): void; };
        _clutter_texture2: { (): void; };
        _clutter_texture3: { (): void; };
        _clutter_texture4: { (): void; };
        _clutter_texture5: { (): void; };
    }
    ...
    class TimelineClass {
        ...
        _clutter_timeline_1: { (): void; };
        _clutter_timeline_2: { (): void; };
        _clutter_timeline_3: { (): void; };
        _clutter_timeline_4: { (): void; };
    }
    ...
    class Vertex {
         ...
         */
        static new(_x: number, _y: number, _z: number): Vertex;
        public x: number;
        public y: number;
        public z: number;
        /**
    ...
    class ZoomActionClass {
        ...
        _clutter_zoom_action1: { (): void; };
        _clutter_zoom_action2: { (): void; };
        _clutter_zoom_action3: { (): void; };
        _clutter_zoom_action4: { (): void; };
        _clutter_zoom_action5: { (): void; };
    }
    ...
    class Container {
         ...
         * @returns 
         */
        static class_list_child_properties(klass: GObject.ObjectClass, n_properties: number): GObject.ParamSpec[];
    }
