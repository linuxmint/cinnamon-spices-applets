declare namespace imports.gi.Pango {
    ...
    class FontClass {
        ...
        get_features: { (font: Font, features: HarfBuzz.feature_t[], len: number, num_features: number): void; };
    ...
    class FontFaceClass {
        ...
        get_family: { (_face: FontFace): FontFamily; };
    ...
    class FontFamilyClass {
        ...
        get_face: { (family: FontFamily, name: string): FontFace; };
    ...
    class FontMapClass {
        ...
        get_face: { (fontmap: FontMap, font: Font): FontFace; };
    }
