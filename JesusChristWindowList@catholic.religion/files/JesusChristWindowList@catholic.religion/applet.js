...
function _(str) {
   let resultConf = Gettext.dgettext('JesusChristWindowList@catholic.religion', str);
   if(resultConf != str) {
      return resultConf;
   }
...
const AppletDir = imports.ui.appletManager.applets['JesusChristWindowList@catholic.religion'];
...
MyApplet.prototype = {
    ...
    _init: function (metadata, orientation, panel_height, instance_id) {
        ...
        try {
            ...
            this.settings = new Settings.AppletSettings(this, "JesusChristWindowList@catholic.religion", instance_id);
