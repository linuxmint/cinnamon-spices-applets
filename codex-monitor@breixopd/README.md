...
The compact panel view shows 5-hour and weekly usage at a glance. Open the dashboard for exact reset countdowns, clear warning text, 24-hour to 30-day history with pointer and keyboard inspection, banked resets, recent and active sessions with current-turn elapsed time, Remote Control pairing and a live connected-device list, confirmed recovery of a verified stale Remote service, and safe Codex update checks.
