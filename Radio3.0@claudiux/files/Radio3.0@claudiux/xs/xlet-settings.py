...
gettext.install(UUID, LOCALE_DIR, names=["dngettext"]);
gettext.bindtextdomain("cinnamon", "/usr/share/locale");
#gettext.install("cinnamon", "/usr/share/locale", names=["dngettext"])
...
if __name__ == "__main__":
    ...
    print("R3 %s" % " ".join(os.path.abspath(sys.argv[0]).split("/")[-2:]))
