...
const DEFAULT_M3U_PATH = RADIO_LISTS_DIR + "/latest.m3u";
...
/**
 * class StationsFileM3u
 */
var StationsFileM3u = class StationsFileM3u {
    constructor (path = DEFAULT_M3U_PATH) {
        this.path = path;
        this.csv_separator = ";";
        this.pls_separator = ":";
    ...
    get_stations_rows () {
        ...
        for (let string of array_strings) {
            ...
            if (string.startsWith("#EXTINF:")) {
                csv_string = "false" + this.csv_separator + string.split("#EXTINF:")[1].split(",", 2)[1] + this.csv_separator;
