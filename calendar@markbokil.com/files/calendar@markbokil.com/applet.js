// Calendar applet calendar@markbokil.com
// Fork of Cinnamon Calendar applet
// version 1.0.0

// change log: added tooltip with date, added right-click prefs menu, removed settings on Calendar popup
// todo: native options window instead of cinnamon-settings calendar
...
MyApplet.prototype = {
    ...
    createContextMenu: function () {
        this.prefs_menu_item = new Applet.MenuItem(_('Date and Time Settings'), Gtk.STOCK_EDIT, 
            Lang.bind(this, this.doPreferences));     
        this._applet_context_menu.addMenuItem(this.prefs_menu_item);
       
    },
    
    doPreferences: function () {
        this._onLaunchSettings();
    },
