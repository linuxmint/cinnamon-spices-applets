...
class Soup3 {
    constructor() {
        ...
        this._httpSession.idle_timeout = 120;
    }
...
class Jobs {
    ...
    add_job(url, params, headers, method="GET", type="json") {
        let job = {url: url, params: params, headers: headers, method: method, type: type};
        this.jobs.push(job)
    }

    unshift() {
        if (this.is_empty()) return null;
        return this.jobs.unshift()
    }
