#!/usr/bin/python3
# This is a palimpsest of /usr/share/cinnamon/cinnamon-settings/cinnamon-settings.py (Cinnamon 4.0.9)
# made to open the Download tab with spices sorted by date.
# Usage: ~/.local/share/cinnamon/applets/SpicesUpdate@claudiux/scripts/open_download_tab.py applets|desklets|extensions|themes
