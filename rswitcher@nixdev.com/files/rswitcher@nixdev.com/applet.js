    ...
    _init: function (orientation) {
        ...
        try {
            ...
            this.menu.addAction(_("HiDPI 125%"), function (event) {
                Main.Util.spawnCommandLine(`${__meta.path}/rswitcher -r max -s 1 -f 125`);
            });
            //Fake 125% Fractional scaling
            this.menu.addAction(_("Fake 125%"), function (event) {
                Main.Util.spawnCommandLine(`${__meta.path}/rswitcher --fake`);
            });
            //Reset Fake 125% Fractional scaling
            this.menu.addAction(_("Reset 100%"), function (event) {
                Main.Util.spawnCommandLine(`${__meta.path}/rswitcher --reset`);
            });
            //2160p
