...
AppMenuButtonRightClickMenu.prototype = {
    ...
    _populateMenu: function() {
        ...
        if (this._launcher._applet.pref_pref_sub_menu_placement !== 0)
            subMenu = new PopupMenu.PopupSubMenuMenuItem(_("Preferences"));

        if (this._launcher._applet.pref_pref_sub_menu_placement === 1) {
        ...
        if (this._launcher._applet.pref_pref_sub_menu_placement === 2) {
            this.addMenuItem(new PopupMenu.PopupSeparatorMenuItem());
            this.addMenuItem(subMenu);
        }
...
MyApplet.prototype = {
    ...
    _bindSettings: function() {
        ...
        let settingsArray = [
            ...
            [bD.IN, "pref_pref_sub_menu_placement", null],
        ];
