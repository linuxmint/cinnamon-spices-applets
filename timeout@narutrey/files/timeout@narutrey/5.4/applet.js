...
AppletTimeout.prototype = {
    ...
    _init: function(metadata, orientation, panelHeight, instanceId) {
        ...
        // This applet is deactivated from Cinnamon 5.4
        // BEGIN
        this.set_applet_icon_symbolic_name("alarm");
        this.set_applet_label("Disabled");
        this.set_applet_tooltip("Disabled for now. Session loss risk since Cinnamon 5.4.");
        return;
        // END
