            ...
            for (let site of dontDisplayArtSites) {
                if (metadata["xesam:url"].unpack().toLowerCase().includes(site) ||
                    ...
                    if (this._applet.iconsWhenNotDisplayingAlbumArt[site].length > 0) {
                        ...
                        switch (site) {
                            case "youtube": 
                                this._trackCoverFile = `file://${APPLET_DIR}/6.6/icons/youtube.png`;
                                this._applet._icon_path = `${APPLET_DIR}/6.6/icons/youtube.png`;
                                this._applet.setAppletIcon(true, true);
                                return;
                            case "spotify": 
                                this._trackCoverFile = `file://${APPLET_DIR}/6.6/icons/spotify.png`;
                                this._applet._icon_path = `${APPLET_DIR}/6.6/icons/spotify.png`;
                                this._applet.setAppletIcon(true, true);
                                return;
                            case "strawberry": 
                                this._trackCoverFile = `file://${APPLET_DIR}/6.6/icons/strawberry.png`;
                                this._applet._icon_path = `${APPLET_DIR}/6.6/icons/strawberry.png`;
                                this._applet.setAppletIcon(true, true);
                                return;
                            default:
