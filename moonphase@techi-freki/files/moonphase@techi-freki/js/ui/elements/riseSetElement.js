const { marginBottom5, paddingTop3, margin5 } = require('./js/ui/styles');
...
class RiseSetElement extends UiElement {
    ...
    create() {
        ...
        const datetimeLayout = this.elementGenerator.generateLayout([headerLabel, dateLabel, timeLabel], true, paddingTop3);
        ...
        const directionLayout = this.elementGenerator.generateLayout([directionNameLabel, directionArrowIcon, directionAngleLabel], false, margin5);
