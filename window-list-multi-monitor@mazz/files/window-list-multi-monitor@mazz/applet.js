...
MyApplet.prototype = {
    ...
    _init: function(orientation, panel_height, instance_id) {        
        ...
        try {                    
            ...
            this.settings = new Settings.AppletSettings(this, "window-list-multi-monitor@mazz", instance_id);
     
            this.settings.bindProperty(Settings.BindingDirection.IN,  // Setting type
                                     "showMonitor",             // The setting key
                                     "showMonitor",             // The property to manage (this.width)
                                     this._refreshItems,  // Callback when value changes
            ...
            global.display.connect('grab-op-end', Lang.bind(this, this._refreshItems));
    ...
    _refreshItems: function() {
        for ( let i = 0; i < this._windows.length; ++i ) {
            ...
            if ((metaWindow.get_workspace().index() == global.screen.get_active_workspace_index()
                      || metaWindow.is_on_all_workspaces()) && metaWindow.get_monitor() == this.showMonitor)
    ...
    _windowAdded: function(metaWorkspace, metaWindow) {
        ...
        if (metaWorkspace.index() != global.screen.get_active_workspace_index() || metaWindow.get_monitor() != this.showMonitor)
