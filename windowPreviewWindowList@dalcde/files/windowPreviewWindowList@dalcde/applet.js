...
WindowPreview.prototype={
	...
	this.metaWindow = metaWindow;
        ...
        this.container = new St.BoxLayout({vertical: true, style_class: "switcher-list"}); //Used two layers of actors in order to apply two style classes
    ...
    _refreshDisplay: function(open){
        ...
        if (mutterWindow){
            ...
            if (this.orientation == St.Side.BOTTOM){
                y1 = parentY - selfActorHeight + offsetY - 5; // Leave a bit of gap
            } else {
                y1 = parentY + parentActorHeight + offsetY + 5;
            }
...
//    __proto__ : AppMenuButton.prototype,
    ...
    _onDragBegin: function() {
        this.preview.close();
        this.preview.preventShow = true;
    },

    _onDragEnd: function() {
        this._applet.myactorbox._clearDragPlaceholder();
        this.preview.preventShow = false;
    },
