...
const Calendar = imports.applet.jalalicalendar;
...
MyApplet.prototype = {
    ...
    _init: function(orientation, panel_height, instance_id) {
        ...
        try {
            ...
            this.settings = new Settings.AppletSettings(this, "jalalicalendar@mohammad-sn", this.instance_id);
            ...
            // jDate
            this._jdate = new St.Label();
            this._jdate.style_class = 'datemenu-date-label';
            vbox.add(this._jdate);
