...
export class AccuWeather implements WeatherProvider<Services.AccuWeather, AccuWeatherOptions> {
	...
	public async GetWeather(loc: LocationData, cancellable: imports.gi.Gio.Cancellable, config: Config, options: AccuWeatherOptions): Promise<WeatherData | null> {
