...
export class DeutscherWetterdienst implements WeatherProvider<Services.DeutscherWetterdienst> {
	public readonly needsApiKey: boolean = false;
	public readonly prettyName: string = _("Deutscher Wetterdienst");
	public readonly name = Services.DeutscherWetterdienst;
	public readonly maxForecastSupport: number = 10;
	public readonly maxHourlyForecastSupport: number = 240;
	public readonly website: string = "https://brightsky.dev/";
