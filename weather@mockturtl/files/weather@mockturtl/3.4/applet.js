...
// Polyfill for Array.includes for 3.6
...
// Polyfill for Babel async: regenerator-runtime
/**
...
var runtime=function(g){function D(a,b,c,e){b=Object.create((b&&b.prototype instanceof y?b:y).prototype);e=new z(e||[]);b._invoke=K(a,c,e);return b}function A(a,b,c){try{return{type:"normal",arg:a.call(b,c)}}catch(e){return{type:"throw",arg:e}}}function y(){}function t(){}function q(){}function E(a){["next","throw","return"].forEach(function(b){a[b]=function(a){return this._invoke(b,a)}})}function u(a){function b(c,d,l,f){c=A(a[c],a,d);if("throw"===c.type)f(c.arg);else{var e=c.arg;return(c=e.value)&&
  "object"===typeof c&&m.call(c,"__await")?Promise.resolve(c.__await).then(function(a){b("next",a,l,f)},function(a){b("throw",a,l,f)}):Promise.resolve(c).then(function(a){e.value=a;l(e)},function(a){return b("throw",a,l,f)})}}var c;this._invoke=function(a,d){function e(){return new Promise(function(c,e){b(a,d,c,e)})}return c=c?c.then(e,e):e()}}function K(a,b,c){var e=F;return function(d,l){if(e===G)throw Error("Generator is already running");if(e===v){if("throw"===d)throw l;return H()}c.method=d;for(c.arg=
  l;;){var f=c.delegate;if(f&&(f=I(f,c))){if(f===h)continue;return f}if("next"===c.method)c.sent=c._sent=c.arg;else if("throw"===c.method){if(e===F)throw e=v,c.arg;c.dispatchException(c.arg)}else"return"===c.method&&c.abrupt("return",c.arg);e=G;f=A(a,b,c);if("normal"===f.type){e=c.done?v:L;if(f.arg===h)continue;return{value:f.arg,done:c.done}}"throw"===f.type&&(e=v,c.method="throw",c.arg=f.arg)}}}function I(a,b){var c=a.iterator[b.method];if(c===k){b.delegate=null;if("throw"===b.method){if(a.iterator["return"]&&
  (b.method="return",b.arg=k,I(a,b),"throw"===b.method))return h;b.method="throw";b.arg=new TypeError("The iterator does not provide a 'throw' method")}return h}c=A(c,a.iterator,b.arg);if("throw"===c.type)return b.method="throw",b.arg=c.arg,b.delegate=null,h;c=c.arg;if(!c)return b.method="throw",b.arg=new TypeError("iterator result is not an object"),b.delegate=null,h;if(c.done)b[a.resultName]=c.value,b.next=a.nextLoc,"return"!==b.method&&(b.method="next",b.arg=k);else return c;b.delegate=null;return h}
  function M(a){var b={tryLoc:a[0]};1 in a&&(b.catchLoc=a[1]);2 in a&&(b.finallyLoc=a[2],b.afterLoc=a[3]);this.tryEntries.push(b)}function B(a){var b=a.completion||{};b.type="normal";delete b.arg;a.completion=b}function z(a){this.tryEntries=[{tryLoc:"root"}];a.forEach(M,this);this.reset(!0)}function C(a){if(a){var b=a[w];if(b)return b.call(a);if("function"===typeof a.next)return a;if(!isNaN(a.length)){var c=-1;b=function d(){for(;++c<a.length;)if(m.call(a,c))return d.value=a[c],d.done=!1,d;d.value=
  k;d.done=!0;return d};return b.next=b}}return{next:H}}function H(){return{value:k,done:!0}}var J=Object.prototype,m=J.hasOwnProperty,k,n="function"===typeof Symbol?Symbol:{},w=n.iterator||"@@iterator",N=n.asyncIterator||"@@asyncIterator",x=n.toStringTag||"@@toStringTag";g.wrap=D;var F="suspendedStart",L="suspendedYield",G="executing",v="completed",h={};n={};n[w]=function(){return this};var p=Object.getPrototypeOf;(p=p&&p(p(C([]))))&&p!==J&&m.call(p,w)&&(n=p);var r=q.prototype=y.prototype=Object.create(n);
  t.prototype=r.constructor=q;q.constructor=t;q[x]=t.displayName="GeneratorFunction";g.isGeneratorFunction=function(a){return(a="function"===typeof a&&a.constructor)?a===t||"GeneratorFunction"===(a.displayName||a.name):!1};g.mark=function(a){Object.setPrototypeOf?Object.setPrototypeOf(a,q):(a.__proto__=q,x in a||(a[x]="GeneratorFunction"));a.prototype=Object.create(r);return a};g.awrap=function(a){return{__await:a}};E(u.prototype);u.prototype[N]=function(){return this};g.AsyncIterator=u;g.async=function(a,
  b,c,e){var d=new u(D(a,b,c,e));return g.isGeneratorFunction(b)?d:d.next().then(function(a){return a.done?a.value:d.next()})};E(r);r[x]="Generator";r[w]=function(){return this};r.toString=function(){return"[object Generator]"};g.keys=function(a){var b=[],c;for(c in a)b.push(c);b.reverse();return function d(){for(;b.length;){var c=b.pop();if(c in a)return d.value=c,d.done=!1,d}d.done=!0;return d}};g.values=C;z.prototype={constructor:z,reset:function(a){this.next=this.prev=0;this.sent=this._sent=k;this.done=
  !1;this.delegate=null;this.method="next";this.arg=k;this.tryEntries.forEach(B);if(!a)for(var b in this)"t"===b.charAt(0)&&m.call(this,b)&&!isNaN(+b.slice(1))&&(this[b]=k)},stop:function(){this.done=!0;var a=this.tryEntries[0].completion;if("throw"===a.type)throw a.arg;return this.rval},dispatchException:function(a){function b(b,d){g.type="throw";g.arg=a;c.next=b;d&&(c.method="next",c.arg=k);return!!d}if(this.done)throw a;for(var c=this,e=this.tryEntries.length-1;0<=e;--e){var d=this.tryEntries[e],
  g=d.completion;if("root"===d.tryLoc)return b("end");if(d.tryLoc<=this.prev){var f=m.call(d,"catchLoc"),h=m.call(d,"finallyLoc");if(f&&h){if(this.prev<d.catchLoc)return b(d.catchLoc,!0);if(this.prev<d.finallyLoc)return b(d.finallyLoc)}else if(f){if(this.prev<d.catchLoc)return b(d.catchLoc,!0)}else if(h){if(this.prev<d.finallyLoc)return b(d.finallyLoc)}else throw Error("try statement without catch or finally");}}},abrupt:function(a,b){for(var c=this.tryEntries.length-1;0<=c;--c){var e=this.tryEntries[c];
