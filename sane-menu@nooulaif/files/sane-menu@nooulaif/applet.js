...
MyApplet.prototype = {
    ...
    _init: function(orientation, panel_height, instance_id) {
        ...
        this.settings = new Settings.AppletSettings(this, "sane-menu@nooulaif", instance_id);
        ...
        this._applicationsButtonsBackup = new Array();
        this._applicationsOrder = new Object();
    ...
    _listApplications: function(category_menu_id, pattern){
        ...
        if (pattern){
            ...
            for (var i in this._applicationsButtons) {
                ...
                var fuzzy = this._fuzzysearch(pattern, Util.latinise(app.get_name().toLowerCase()));
                if (fuzzy[0]) {
                    res.push(app.get_id());
