...
if __name__ == "__main__":
    ...
    message = _("The radio applet depends on the '%s' plugin. It's a 3rd party plugin for mpv, which allows controlling the radio player with the sound applet.") % ('mpv-mpris') + "\n\n" + _("Do you want to proceed the download at your own risk?")
