...
class CancelDownload():
    def __init__(self):
        ...
        if response == 0:
            ...
            print("Cancel")
            subprocess.call(
                ["xdg-open", "https://packages.debian.org/sid/all/youtube-dl/download"])
        else:
            print("Cancel")
...
if __name__ == "__main__":
    ...
    message = _("This function depends on the newest version of the '%s' apt package. Currently the newest version of this package is only included in the Debian package respository but not yet in the default Linux Mint repositories.") % (
